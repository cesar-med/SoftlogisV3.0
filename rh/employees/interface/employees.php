...
<script type="module" src="./../rh/employees/interface/EmployeeEvents.js"></script>
    ...
    <div class="contentGenerally">
        <div class="rowHeadersPage">
            <div class="contentImagePage">
                <div class="textPageTitle">Empleados</div>
            </div>
            <div class="contentFunctionPage">
                ...
                <button type="button" class="btnFunctionPage" title="Exportar empleados" data-value="employees">
        ...
        <div class="contentBodyPage" id="employeesContainerData">
        </div>
